    ...
    <main className="landing-page flex min-h-screen flex-col bg-white">
      ...
      <section className="border-b border-[#dadada] bg-[#f9f9f9]">
        <div className="mx-auto max-w-[1100px] px-4 py-10 sm:px-6 sm:py-14">
          ...
          <h1 className="mt-2 font-[family-name:var(--font-outfit),sans-serif] text-[28px] font-bold leading-[1.15] text-[#027a3b] sm:text-[36px]">
            Zemen Service Platform
          </h1>
          <p className="mt-4 max-w-[820px] font-[family-name:var(--font-outfit),sans-serif] text-[16px] font-normal leading-[1.45] text-[#4b4b4b]">
      ...
      <section className="mx-auto w-full max-w-[1100px] flex-1 px-4 py-10 sm:px-6 sm:py-12">
        <div className="grid gap-6 md:grid-cols-2">
          {productHighlights.map((item) => (
            ...
            >
              ...
              <p className="mt-3 font-[family-name:var(--font-outfit),sans-serif] text-[15px] font-normal leading-[1.45] text-[#5a5a5a]">
                {item.description}
              </p>
            </article>
          ))}
        ...
        <section className="mt-8 rounded-md border border-[#ededed] bg-white p-6 shadow-[0_1px_3px_rgba(0,0,0,0.06)] sm:p-8">
          ...
          <ul className="mt-4 space-y-3">
            {targetUsers.map((item) => (
              <li
                key={item}
                className="rounded-md border border-[#d8e7cd] bg-[#f6fbf2] px-4 py-3 font-[family-name:var(--font-outfit),sans-serif] text-[15px] font-medium text-[#234a12]"
              >
                {item}
              </li>
            ))}
        ...
        <section className="mt-8 rounded-md border border-[#027a3b] bg-[#f6fbf2] p-6 sm:p-8">
          ...
          <p className="mt-3 max-w-[760px] font-[family-name:var(--font-outfit),sans-serif] text-[15px] font-normal leading-[1.45] text-[#3f3f3f]">
