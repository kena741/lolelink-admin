                            ...
                            <div className="flex items-center justify-between gap-6">
                                <div>
                                    <div className="mb-2 flex items-center gap-3">
                                        <Link href="/admin/customers" className="rounded-lg bg-card/15 p-2 backdrop-blur-sm transition-colors hover:bg-card/25">
                                    ...
                                    <div className="flex items-center gap-2 text-sm text-primary-foreground/90">
                                        <Link href="/admin/dashboard" className="transition-colors hover:text-primary-foreground">Dashboard</Link>
                                        <span>/</span>
                                        <Link href="/admin/customers" className="transition-colors hover:text-primary-foreground">Customers</Link>
                                        <span>/</span>
                                        <span className="font-semibold text-primary-foreground">Job Requests</span>
                                    </div>
                                </div>
                                <button
