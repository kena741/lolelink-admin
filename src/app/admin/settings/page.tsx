                        ...
                        {activeTab === 'constants' && (
                            <div className="rounded-2xl bg-white/80 backdrop-blur-xl border border-white/20 shadow-xl p-6">
                                ...
                                <div className="grid grid-cols-1 gap-6 max-w-2xl">
                                    ...
                                    <div>
                                        <label className="block text-sm font-medium text-gray-700 mb-2">
                                            Minimum withdraw amount (ETB)
                                        </label>
                                        <input
                                            type="text"
                                            value={constants.minimum_amount_withdraw || ''}
                                            onChange={(e) =>
                                                setConstants({
                                                    ...constants,
                                                    minimum_amount_withdraw: e.target.value,
                                                })
                                            }
                                            className="w-full rounded-lg border border-gray-300 bg-white px-4 py-2 text-sm text-gray-900 focus:border-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-200"
                                        />
                                    ...
                                    <div>
                                        <label className="block text-sm font-medium text-gray-700 mb-2">
                                            Maximum withdraw amount (ETB)
                                        </label>
                                        <input
                                            type="text"
                                            value={constants.maximum_amount_withdraw || ''}
                                            onChange={(e) =>
                                                setConstants({
                                                    ...constants,
                                                    maximum_amount_withdraw: e.target.value,
                                                })
                                            }
                                            className="w-full rounded-lg border border-gray-300 bg-white px-4 py-2 text-sm text-gray-900 focus:border-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-200"
                                        />
